          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex items-center gap-1 bg-slate-100 rounded-lg p-1">
              <button
                ...
                className={`px-3 py-2 text-sm font-medium rounded-md transition-colors ${dateRange === 'week'
              ...
              <button
                ...
                className={`px-3 py-2 text-sm font-medium rounded-md transition-colors ${dateRange === 'month'
                  ? 'bg-white text-slate-900 shadow-sm'
                  : 'text-slate-600 hover:text-slate-900'
                  }`}
              >
              ...
              <button
                ...
                className={`px-3 py-2 text-sm font-medium rounded-md transition-colors ${dateRange === 'year'
                  ? 'bg-white text-slate-900 shadow-sm'
                  : 'text-slate-600 hover:text-slate-900'
                  }`}
              >
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 md:gap-6">
                ...
                {reportData.products?.products && (
                  <div className="bg-white rounded-xl p-4 md:p-6 shadow-sm border border-slate-200 overflow-hidden hover:shadow-md transition-shadow duration-300">
                    ...
                    <div className="mt-4">
                      <TopProductsChart products={reportData.products.products} />
                    </div>
                  </div>
                )}
