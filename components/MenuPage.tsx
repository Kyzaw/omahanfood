    ...
    <section className="my-12">
      ...
      <div className="flex gap-4 overflow-x-auto px-4 py-6 scrollbar-hide">
        <div
          ...
          className={`flex flex-col items-center min-w-[90px] cursor-pointer transition-all duration-300 hover:scale-105 ${selectedCategory === null
              ? "transform scale-105"
              : "hover:transform hover:scale-105"
            }`}
        >
          <div className={`w-24 h-24 rounded-2xl overflow-hidden shadow-lg flex items-center justify-center transition-all duration-300 ${selectedCategory === null
          ...
          <span className={`text-sm font-semibold mt-3 transition-colors ${selectedCategory === null ? "text-orange-600" : "text-gray-700"
            }`}>
            All Items
          </span>
        ...
        {categories.map((cat) => (
          <div
            ...
            className={`flex flex-col items-center min-w-[90px] cursor-pointer transition-all duration-300 hover:scale-105 ${selectedCategory === cat.name
                ? "transform scale-105"
                : ""
              }`}
          >
            <div className={`w-24 h-24 rounded-2xl overflow-hidden shadow-lg transition-all duration-300 ${selectedCategory === cat.name
              ...
              {cat.image ? (
                ...
                <div className={`w-full h-full flex items-center justify-center text-sm font-medium ${selectedCategory === cat.name
            ...
            <span className={`text-sm font-semibold mt-3 text-center transition-colors ${selectedCategory === cat.name ? "text-orange-600" : "text-gray-700"
              }`}>
              {cat.name}
            </span>
