                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex items-center gap-2 mt-1">
                                                        ...
                                                        {order.jenisPaket && order.jenisPaket !== 'HARIAN' && (
                                                            <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-bold bg-orange-100 text-orange-600 border border-orange-200 uppercase">
                                                                {order.jenisPaket} ({order.deliveredCount}/{order.totalDeliveries})
                                                            </span>
                                                        )}
                                                    </div>
                                                </div>
